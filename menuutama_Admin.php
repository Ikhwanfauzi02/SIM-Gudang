...
<nav class="navbar navbar-expand-sm  navbar-dark">
	<div class="container">
		...
		<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
		  <span class="navbar-toggler-icon"></span>
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="menuutama_Admin.php" style="color: white">Beranda</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="transaksibarang.php" target="frmmenu" style="color: white">Transaksi</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" style="color: white">Master</a>
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<li>	
							<form class="dropdown-item" action="AddUser.php" method="post">
								<button class="dropdown-item" >Add User</button>
							</form>
						</li>
						<li>
	...
	<div class="container-fluid mt-3">
		<iframe src="beranda_Admin.php" name="frmmenu" width="100%" height="625px"></iframe>
	</div>
