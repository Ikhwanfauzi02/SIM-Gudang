...
<form method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
    <div id="NamaBarang" name="NamaBarang" type="text" class="form-control"></div>  
    </div>
  </div><br>
  <div class="form-group row">
    <label for="WaktuTransaksi" class="col-4 col-form-label">Waktu Transaksi</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="submit" type="submit" class="btn btn-primary">Eksekusi</button>
    </div>
  </div>
</form>
